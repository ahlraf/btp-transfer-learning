...
url_test = "https://github.com/ahlraf/btp-transfer-learning/raw/master/experiment-9/testdata1.csv"
df_test = pd.read_csv(url_test, header="infer", skip_blank_lines=True, encoding="utf-8")

df_test1 = df_test[["text_post","label_a"]]
# print(df_test1.head())
...
print(df_test1.head())
print("Original count:", df_test1['label'].value_counts(normalize=False))
...
for train_index, val_index in skf.split(x,y):
  ...
  folds.append([train, eval, df_test1])
